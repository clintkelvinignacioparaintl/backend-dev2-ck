...
const two_factor_service_2 = require("../common/services/two-factor.service");
...
exports.TwoFactorModule = TwoFactorModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [two_factor_service_1.TwoFactorService, two_factor_service_2.TwoFactorService],
